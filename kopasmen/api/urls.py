...
from .views import LoginView, CheckNIPView, ResetPasswordView, SimpananListView, PenarikanListView, PinjamanListView, AngsuranListView
urlpatterns = [
    ...
    path('<int:id_pinjaman>/angsuran/', AngsuranListView.as_view(), name='angsuran-list'),
]
